...
noise_position = CreateSourcePosition(noise_angle,Mic_Source_Distance,Room(1),Room(2),Room(3));
...
noise_in_rir = ConvWithRIR(noise,RIR_noise);
...
mix_rir = audio_in_rir + noise_in_rir;
...
legend('DSB Audio out','Ref Target Audio in');
xlabel("Time/s"); ylabel("Amplitude");
title("Waveform of setting: Steer at 0 - Target at 0 - Interference at 90 degree");
hold off;

subplot(122);
v_spgrambw(signal_output_DSB_time,fs,'pJcw') ;
title("Spectrogram of setting: Steer at 0 - Target at 0 - Interference at 90 degree");
