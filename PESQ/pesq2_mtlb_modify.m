function [ scores ] = pesq2_mtlb_modify( reference, degraded, fs, mode, binary, pathaudio_reference, pathaudio_degraded)
...
%     expdir = pwd();
    ...
    reference = [pathaudio_reference filesep reference];
    degraded = [pathaudio_degraded filesep degraded];
