...
fprintf('==================================\n'); 
    ...
    % display results to screen
fprintf('====================\n'); 
disp('WB-PESQ score for FW:');
fprintf( 'WB MOS LQO  = %5.3f\n', wb_FW_average );
fprintf('==================================\n');

PESQ_matrix__bus = [wb_REF', wb_DSB', wb_MVDR', wb_FW', wb_FW_BAN', wb_GEV_NOBAN',wb_GEV_BAN'];

figure
boxplot(PESQ_matrix__bus,'Labels',{'REF', 'DSB', 'MVDR', 'FF+GEV', 'FF+GEV+BAN', 'BLSTM+GEV', 'BLSTM+GEV+BAN'})
xlabel('Beamforming techniques')
ylabel('PESQ Score')

title('Box and whisker plot of PESQ for different beamformering techniques (For BUS Real Data)')
