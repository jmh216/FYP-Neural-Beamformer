...
PESQ_matrix_ped = [wb_REF', wb_DSB', wb_MVDR', wb_FW', wb_FW_BAN', wb_GEV_NOBAN',wb_GEV_BAN'];

figure
boxplot(PESQ_matrix_ped,'Labels',{'REF', 'DSB', 'MVDR', 'FF+GEV', 'FF+GEV+BAN', 'BLSTM+GEV', 'BLSTM+GEV+BAN'})
xlabel('Beamforming techniques')
ylabel('PESQ Score')

title('Box and whisker plot of PESQ for different beamformering techniques (For PED Real Data)')
